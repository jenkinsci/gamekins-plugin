...
class SendChallengeQuestTaskTest : FeatureSpec({

    val questTask = SendChallengeQuestTask()
    ...
    feature("printToXML") {
        scenario("Without indentation") {
            questTask.printToXML("") shouldBe "<SendChallengeQuestTask created=\"${questTask.created}\" solved=\"${questTask.solved}\" currentNumber=\"${questTask.currentNumber}\" numberGoal=\"1\">"
        }
    ...
    feature("toString") {
        questTask.toString() shouldBe "Send one challenge to your colleagues"
    }
})